...
const manifestFilePath = join(__dirname, '../custom_components/v2c_cloud/manifest.json');
const constantFilePath = join(__dirname, '../custom_components/v2c_cloud/const.py');
