...
> 🎁 Thinking about a new wallbox? Grab a **10% discount** on Trydan or Trydan Pro at the official V2C store (https://v2charge.com/store/it/) with the promo code `INTEGRATIONTRYDAN10`, for more info visit: [https://samuele.bistoletti.me/v2c-discount-code/](https://samuele.bistoletti.me/v2c-discount-code/)
