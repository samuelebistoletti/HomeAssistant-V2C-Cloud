...
const manifestFilePath = join(__dirname, '../custom_components/octopus_energy_it/manifest.json');
const constantFilePath = join(__dirname, '../custom_components/octopus_energy_it/const.py');
